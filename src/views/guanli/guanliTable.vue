<template>
  <div class="user">
    ...
    >
      ...
      <el-table-column label="用户等级" prop="group" sortable></el-table-column>
      <el-table-column label="用户信息" prop="title"></el-table-column>
      <el-table-column label="创建时间" prop="create_date" ></el-table-column>
      <el-table-column label="状态" width="120">
        <template slot-scope="scope">
          <span>{{ scope.row.active ? '正常':'锁定' }}</span>
        </template>
      </el-table-column>
...
<script>
import UserForm from '@/views/guanli/guanliForm'
